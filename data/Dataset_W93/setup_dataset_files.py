...
if __name__ == "__main__":
    ...
    for i in tqdm(range(count)):
        ...
        create_pdb_from_file_path(product_path, f"data/Clean_Geometries/Reaction_{i}/Product_geometry.xyz")
        create_pdb_from_file_path(reactant_path, f"data/Clean_Geometries/Reaction_{i}/Reactant_geometry.xyz")
        create_pdb_from_file_path(ts_path, f"data/Clean_Geometries/Reaction_{i}/TS_geometry.xyz")
        ...
        combined_image.paste(product_image, (image_width + 20, 0))  # Add 20 pixels for spacing

        # Save the combined image as a PNG file
        image_path = os.path.join(f"data/Clean_Geometries/Reaction_{i}/Reaction_image.png")

...
class QM90_TS_no_product(Dataset):
    def __init__(
        self,
        directory="Diffusion_Project/Dataset/data/Clean_Geometries",
...
if __name__ == "__main__":
    ...
    train_example, train_example_node_mask = train_dataset[0]
    print(train_example)
    print((train_example.edge_index[0] == 23).sum())

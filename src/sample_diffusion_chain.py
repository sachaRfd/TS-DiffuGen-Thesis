""""
This script it to create samples including their intermediate steps for visualisation as a GIF: 
----------------------------------------------------------------------------------------------
"""
import os
import torch
...
if __name__ == "__main__":
    ...
    # Setup models:
    save_path = "src/Diffusion/Clean_lightning/BEST_MODEL_False_Random_rotations_True_augment_train_set_8_layers_64_hiddenfeatures_0.0001_lr_sigmoid_2_2000_timesteps_64_batch_size_2000_epochs_False_Rem_Hydrogens/Sample_chain/"
    ...
    # Load weights:
    model_path = "src/Diffusion/Clean_lightning/BEST_MODEL_False_Random_rotations_True_augment_train_set_8_layers_64_hiddenfeatures_0.0001_lr_sigmoid_2_2000_timesteps_64_batch_size_2000_epochs_False_Rem_Hydrogens/Weights/weights.pth"
    ...
    sample_chain = lit_diff_model.diffusion_model.sample_chain(inflated_h, number_samples, 23, keep_frames=keep_frames, node_mask=example_node_mask, edge_mask=edge_mask)
    ...
    for i in range(keep_frames):
        ...
        predicted_samples = return_xyz(predicted_samples, dataset=lit_diff_model.dataset)

        # Save the file in the example_folder and with the name its Iteration number: 

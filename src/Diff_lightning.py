...
from Diffusion.Equivariant_Diffusion import DiffusionModel
...
class LitDiffusionModel(pl.LightningModule):
    def __init__(
        ...
        self.denoising_model = model_dynamics_with_mask.EGNN_dynamics_QM9(
...
if __name__ == "__main__":
    ...
    wandb_logger = pytorch_lightning.loggers.WandbLogger(
        project="Diffusion_5_layer_2000_timesteps", name=model_name
    )

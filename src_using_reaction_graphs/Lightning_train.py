...
Currently code is implemented to only contain graph information
...
class LitDiffusionModel(pl.LightningModule):
    ...
    def sample_and_test(
        ...
        if self.save_samples:
            ...
            # reactant_filename = os.path.join(folder_path, "true_reactant.xyz")    # noqa
    ...
    def test_step(self, batch, batch_idx):
        ...
        for i in range(test_coords.shape[0]):
            ...
            test_h = test_coords[i, :, :-9].unsqueeze(  # Was previously 3
                0
...
if __name__ == "__main__":
    ...
    folder_name = (
        "src_using_reaction_graphs/Diffusion/weights_and_samples/"
        + model_name
        + "/"  # noqa
    )  # noqa
    ...
    path_to_load = "src_using_reaction_graphs/Diffusion/weights_and_samples/only_GRAPH_True_use_product_graph_W93_dataset_False_include_VAN_DER_WAAL_RADII_False_Random_rotations_False_augment_train_set_8_layers_64_hiddenfeatures_0.0001_lr_sigmoid_2_1000_timesteps_64_batch_size_5001_epochs_False_Rem_Hydrogens_second/Weights/weights.pth"  # noqa

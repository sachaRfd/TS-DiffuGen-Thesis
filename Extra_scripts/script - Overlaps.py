...
for directory in directory_list:
    ...
    file_list = [file for file in os.listdir('.') if file.startswith('sample')]
    ...
    for file in file_list:
        ...
        pymol.cmd.align("my_structure", "true_samples")


        # Calculate RMSD
        rmsd = pymol.cmd.rms_cur("my_structure", "true_samples")
        # rmsd = 1
        # Save the overlap image with RMSE value
        overlap_image_name = "overlap_{}_{}.png".format(os.path.splitext(file)[0], rmsd)
        pymol.cmd.png(overlap_image_name, width=800, height=600, dpi=300, ray=1)
